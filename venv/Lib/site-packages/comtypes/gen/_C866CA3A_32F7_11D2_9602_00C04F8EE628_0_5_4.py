...
__all__ = [
    'DISPID_SVEViseme', 'SPAUDIOOPTIONS', 'DISPID_SpeechRecognizer',
    'SPAUDIOSTATUS', 'DISPID_SpeechBaseStream',
    'DISPID_SPIAudioSizeBytes', 'SPEI_TTS_AUDIO_LEVEL', 'SVSFDefault',
    'DISPID_SPIProperties', 'SpeechCategoryRecognizers',
    'DISPID_SpeechLexiconWord', 'tagSPPROPERTYINFO',
    'DISPID_SABufferInfo', 'SpeechUserTraining', 'SPWF_INPUT',
    'ISpObjectTokenCategory', 'tagSTATSTG', 'DISPID_SRState',
    'SpeechCategoryRecoProfiles',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRCEInterference', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRGIsPronounceable', 'DISPID_SVSLastResult',
    'DISPID_SRGDictationLoad', 'SAFTADPCM_11kHzMono',
    'DISPID_SGRSTsItem', 'SVP_21', 'SSFMCreate', 'DISPID_SOTId',
    'SPWF_SRENGINE', 'DISPID_SRGDictationSetState', 'SVF_Stressed',
    'SPEI_RESERVED3', 'DISPID_SPIAudioSizeTime', 'SPCT_DICTATION',
    'DISPID_SLWs_NewEnum', 'DISPID_SRRTimes', 'SPSModifier',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRCEPhraseStart',
    'DISPID_SLPPhoneIds', 'ISpPhoneticAlphabetConverter',
    'SpeechInterference', 'SPINTERFERENCE_TOOSLOW', 'SPRULESTATE',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVEEnginePrivate',
    'SpeechTokenValueCLSID', 'SGSEnabled',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPRuleConfidence',
    'DISPID_SVEVoiceChange', 'IInternetSecurityMgrSite',
    'DISPID_SPEsCount', 'DISPID_SpeechLexiconProns',
    'Speech_Default_Weight', 'SAFTNonStandardFormat', 'SVP_13',
    'SRATopLevel', 'Speech_StreamPos_RealTime',
    'DISPID_SPEDisplayText', 'DISPID_SOTGetDescription',
    'DISPID_SpeechAudioFormat', 'SPSNoun', 'SPEI_PHONEME',
    'SVSFParseMask', '_ISpeechVoiceEvents', 'SpeechCategoryVoices',
    'DISPID_SVSkip', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRSCurrentStreamNumber', 'SVPAlert',
    'DISPID_SOTGetStorageFileName', 'SVSFIsNotXML', 'DISPID_SBSRead',
    'DISPID_SVSCurrentStreamNumber', 'SAFT32kHz16BitStereo',
    'SpSharedRecoContext', 'SpeechCategoryAudioOut', 'SPEI_SOUND_END',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SLPSymbolic',
    'SPCS_DISABLED', 'SVP_5', 'DISPID_SPIStartTime',
    'DISPID_SRRSetTextFeedback', 'SPSHT_NotOverriden', 'SPEI_MIN_SR',
    'SPRST_INACTIVE_WITH_PURGE', 'SASRun', 'SAFTCCITT_uLaw_11kHzMono',
    'eLEXTYPE_MORPHOLOGY', 'SRTExtendableParse', 'ISpMMSysAudio',
    'SVSFNLPSpeakPunc', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SVESentenceBoundary', 'SBOPause', 'SPPHRASERULE',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechFormatType',
    'ISpObjectToken', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SECFIgnoreKanaType', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SPAPhraseInfo', 'SVP_18', 'SAFTGSM610_44kHzMono',
    'SPSVerb', 'DISPID_SpeechMemoryStream',
    'ISpeechPhraseReplacements', 'SPVPRI_OVER',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRSetPropertyString', 'SVP_4',
    'DISPID_SOTRemoveStorageFileName', 'DISPIDSPRG',
    'SPEI_SR_PRIVATE', 'SAFT16kHz8BitMono',
    'DISPID_SRCEPropertyStringChange', 'SREStreamStart',
    'DISPID_SAEventHandle', 'eLEXTYPE_RESERVED4',
    'SAFT12kHz16BitStereo', 'SPEI_WORD_BOUNDARY',
    'DISPID_SCSBaseStream', 'DISPID_SPCPhoneToId', 'SpVoice',
    'DISPID_SRRAudioFormat', 'SPEI_MAX_TTS', 'DISPID_SGRName',
    'DISPID_SRRSpeakAudio', 'SVP_6', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPIGetDisplayAttributes', 'SPEI_END_SR_STREAM',
    'DISPID_SpeechPhraseRules', 'IEnumString', 'SITooSlow',
    'DISPID_SpeechPhraseReplacement', 'SGDSActiveUserDelimited',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SGSExclusive',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPRULE', 'SAFTExtendedAudioFormat',
    'DISPID_SAFGuid', 'ISpRecognizer', 'SPAR_Low', 'SVP_1',
    'SP_VISEME_12', 'DISPID_SLWWord', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPIRule', 'DISPID_SWFEBlockAlign', 'SPSNotOverriden',
    'SWPUnknownWordPronounceable', 'SpeechTokenKeyAttributes',
    'SAFT8kHz16BitMono', 'SAFT24kHz16BitStereo', 'DISPID_SPCLangId',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SGRClear',
    'ISpeechWaveFormatEx', 'ISpeechPhraseRules',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPELexicalForm',
    'SGSDisabled', 'ISpeechGrammarRuleStateTransition',
    'SRERequestUI', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SOTCreateInstance', 'SPSFunction',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCEAudioLevel',
    'ISpObjectWithToken', 'DISPID_SRGCmdLoadFromMemory',
    'ISpeechPhraseRule', 'DISPID_SOTCSetId',
    'ISpeechTextSelectionInformation', 'Speech_Max_Word_Length',
    'SPSEMANTICFORMAT', 'DISPID_SVWaitUntilDone', 'SPPS_RESERVED3',
    'DISPID_SPEAudioSizeBytes', 'eWORDTYPE_DELETED', 'SPEI_MAX_SR',
    'ISpPhoneConverter', 'DISPID_SRRecognizer', 'SRTAutopause',
    'SP_VISEME_8', 'DISPID_SRCEAdaptation', 'SREPropertyNumChange',
    'SpeechTokenKeyUI', 'DISPID_SVStatus', 'DISPID_SOTIsUISupported',
    'SpeechRunState', 'SPPS_RESERVED4', 'ISpeechAudioBufferInfo',
    'DISPID_SpeechPhraseBuilder', 'ISpRecoGrammar2',
    'DISPID_SVEBookmark', 'ISpEventSink', 'STSF_AppData',
    'ISpPhraseAlt', 'SECNormalConfidence', 'DISPID_SPACommit',
    'SPAS_RUN', 'eLEXTYPE_RESERVED6', 'SRTSMLTimeout',
    'DISPID_SLWsItem', 'DISPID_SOTCDefault', 'SAFT32kHz8BitMono',
    'DISPID_SPCIdToPhone', 'SPEI_SR_RETAINEDAUDIO',
    'SAFT48kHz8BitStereo', 'SPCT_SUB_DICTATION', 'SASPause',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechPhraseElement',
    'SPSTREAMFORMATTYPE', 'SAFT32kHz8BitStereo', 'SRERecognition',
    'eLEXTYPE_PRIVATE17', 'SWPKnownWordPronounceable', 'SVP_12',
    'DISPID_SRIsUISupported', 'SPINTERFERENCE_TOOLOUD',
    'SPPS_Unknown', '_RemotableHandle', 'DISPID_SABufferNotifySize',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPRuleName',
    'DISPID_SADefaultFormat', 'eLEXTYPE_PRIVATE9',
    'SPBOOKMARKOPTIONS', 'DISPID_SRDisplayUI',
    'DISPID_SpeechPhraseRule', 'DISPID_SRRTTickCount', 'SFTInput',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SPEDisplayAttributes', 'SAFT22kHz16BitStereo',
    'SPEVENTENUM', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SDKCreateKey', 'ISpeechPhraseReplacement',
    'DISPID_SPRText', 'SPSUnknown', 'SP_VISEME_7', 'STCLocalServer',
    'DISPID_SGRAttributes', 'DISPID_SDKSetStringValue', 'SPAO_NONE',
    'ISpeechVoiceStatus', 'DISPID_SVGetAudioOutputs',
    'DISPID_SREmulateRecognition', 'SPDKL_LocalMachine',
    'eLEXTYPE_PRIVATE18', 'ISpeechPhraseInfoBuilder',
    'DISPID_SPRuleFirstElement', 'SP_VISEME_13',
    'ISpeechLexiconPronunciation', 'SpAudioFormat',
    'SpeechVoicePriority', 'DISPID_SRGCmdSetRuleState',
    'SECFEmulateResult', 'SAFTADPCM_11kHzStereo',
    'SpeechAudioFormatType', 'SPGRAMMARWORDTYPE',
    'DISPID_SRCESoundEnd', 'SAFTText', 'SITooQuiet',
    'DISPID_SOTsItem', 'SRADynamic', 'SpeechAudioProperties',
    'STCRemoteServer', 'SPAR_Unknown', 'SVP_14',
    'SpeechAudioFormatGUIDWave', 'SDTProperty',
    ...
    'SVP_8', 'SINoise', 'SpeechEmulationCompareFlags',
    'eLEXTYPE_USER', 'ISpNotifySource', 'SDKLCurrentUser',
    'SPAUDIOSTATE', 'SpCustomStream', 'DISPID_SpeechObjectToken',
    'SREHypothesis', 'DISPID_SVAudioOutputStream', 'SPRS_INACTIVE',
    'SpWaveFormatEx', 'SPLO_STATIC', 'SpNotifyTranslator',
    'SVF_Emphasis', 'DISPID_SPIReplacements', 'DISPID_SPPConfidence',
    'ISpeechAudioStatus', 'ISpeechRecoGrammar',
    'DISPID_SRSCurrentStreamPosition', 'SPSERIALIZEDPHRASE',
    'ISpeechGrammarRuleStateTransitions',
    'ISpeechLexiconPronunciations', 'DISPID_SpeechRecoContext',
    'eLEXTYPE_RESERVED8', 'ISpSerializeState',
    'SPEI_RECO_OTHER_CONTEXT', 'SPSEMANTICERRORINFO',
    'ISpRecoContext', 'SECFNoSpecialChars', 'SAFTNoAssignedFormat',
    'DISPID_SRGReset', 'SPSHT_Unknown', 'DISPID_SWFEFormatTag',
    'DISPID_SVAlertBoundary', 'ISpeechPhraseElements',
    'DISPID_SVEAudioLevel', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRRTLength', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpeechGrammarRuleState', 'DISPID_SABIEventBias',
    'SECHighConfidence', 'DISPID_SPERequiredConfidence',
    'DISPID_SPILanguageId', 'eWORDTYPE_ADDED', 'SAFT44kHz8BitStereo',
    'DISPID_SLPsItem', 'SPPS_Verb', 'SpeechStreamFileMode',
    'SPEI_RECOGNITION', 'ISpeechPhraseProperties', 'SPFM_CREATE',
    'SpeechRecoEvents', 'ISpEventSource', 'SVSFIsFilename',
    'SSTTTextBuffer', 'SAFT11kHz8BitStereo', 'ISpStream',
    'ISpeechCustomStream', 'SPSHORTCUTTYPE', 'DISPID_SLPsCount',
    'SPWORDPRONUNCIATIONLIST', 'SP_VISEME_6', 'DISPID_SPIGrammarId',
    'DISPID_SOTDataKey', 'DISPID_SPPsCount', 'DISPID_SGRAddResource',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SVSVisemeId',
    'SRAImport', 'DISPID_SLWsCount', 'SAFT44kHz8BitMono',
    'DISPID_SOTCategory', 'SPRST_ACTIVE', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SMSADeviceId',
    'SpeechRecoContextState', 'SVSFIsXML', 'Speech_Max_Pron_Length',
    'SpeechRuleState', 'SP_VISEME_15', 'eLEXTYPE_PRIVATE15',
    'ISpeechMMSysAudio', 'SPEI_SR_BOOKMARK', 'SPVPRI_NORMAL',
    'DISPID_SOTMatchesAttributes', 'SAFT48kHz8BitMono',
    'SVEEndInputStream', 'SVEPrivate', 'SPDKL_DefaultLocation',
    'DISPID_SpeechGrammarRuleStateTransition', 'SLODynamic',
    'DISPID_SMSALineId', 'SINone', 'SpeechAudioState',
    'DISPID_SVResume', 'DISPID_SRProfile', 'SPPARTOFSPEECH',
    'DISPID_SPPNumberOfElements', 'DISPID_SASState',
    'DISPID_SRCRequestedUIType',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPERetainedSizeBytes', 'SpeechDiscardType',
    'DISPID_SGRSTPropertyId', 'SpUnCompressedLexicon',
    'DISPID_SpeechPhoneConverter', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpeechPhoneConverter', 'DISPID_SRStatus', 'DISPID_SRCResume',
    'ISpeechRecoResultDispatch', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPAs_NewEnum', 'SRSEDone', 'SpeechEngineProperties',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechAddRemoveWord', 'SPBO_NONE',
    'DISPID_SRCESoundStart', 'ISpRecognizer3', 'SRTEmulated',
    'DISPID_SAVolume', 'SAFT16kHz8BitStereo', 'DISPID_SPRulesCount',
    ...
    'DISPID_SGRSRule', 'ISpeechObjectTokens', 'Speech_StreamPos_Asap',
    'SPRST_INACTIVE', 'DISPID_SASetState', 'SPAR_Medium',
    'SAFTGSM610_22kHzMono', 'SSSPTRelativeToEnd', 'SDTAll',
    'SVSFUnusedFlags', 'DISPID_SGRSAddWordTransition', 'SP_VISEME_1',
    'DISPID_SWFEAvgBytesPerSec', 'eLEXTYPE_PRIVATE19',
    'SPPHRASEELEMENT', 'DISPID_SMSAMMHandle', 'DISPID_SPPValue',
    'SPBO_PAUSE', 'SAFT22kHz8BitStereo', 'SPEI_RESERVED2',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SDKGetlongValue',
    'ISpStreamFormatConverter', 'DISPID_SVVolume', 'SPWT_LEXICAL',
    'SPSHORTCUTPAIR', 'SVEAllEvents', 'SREStreamEnd',
    'SpeechCategoryAppLexicons', 'SpeechDictationTopicSpelling',
    'DISPID_SPIEnginePrivateData', 'SVP_10',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRCRetainedAudioFormat',
    'SAFTADPCM_8kHzMono', 'SGDSInactive', 'DISPID_SRGCommit',
    'SVEBookmark', 'SINoSignal', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRRAlternates', 'DISPID_SBSWrite',
    'SpeechDisplayAttributes', 'SP_VISEME_11', 'DISPID_SVPause',
    'SpShortcut', 'eLEXTYPE_USER_SHORTCUT', 'SRAExport',
    'SGLexicalNoSpecialChars', 'SpeechGrammarState',
    'DISPID_SpeechDataKey', 'DISPID_SVSInputSentenceLength',
    'SDA_Consume_Leading_Spaces', 'ISpeechRecognizerStatus',
    'ISpNotifySink', 'SAFT44kHz16BitStereo',
    'SpeechRecoProfileProperties', 'SPVISEMES', 'DISPID_SPEsItem',
    'SPEI_HYPOTHESIS', 'ISequentialStream',
    'DISPID_SPRNumberOfElements', 'SPSSuppressWord',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRGState',
    'DISPID_SpeechRecoResult2', 'DISPID_SDKDeleteKey',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SP_VISEME_21',
    'SPSERIALIZEDRESULT', 'ISpRecoContext2', 'SPEI_VISEME',
    'DISPID_SpeechPhraseElements', 'DISPID_SPPName',
    'DISPID_SGRsDynamic', 'eLEXTYPE_PRIVATE16',
    'DISPID_SABIMinNotification', 'SpeechCategoryAudioIn',
    'SPVPRI_ALERT', 'DISPID_SPEPronunciation', 'ISpGrammarBuilder',
    'DISPID_SRRTOffsetFromStart', 'ISpeechRecoResult2', 'SLTApp',
    'SPLO_DYNAMIC', 'DISPID_SDKDeleteValue', 'SPBO_AHEAD',
    'eLEXTYPE_PRIVATE5', 'SRARoot', 'SPEVENTSOURCEINFO',
    'DISPID_SRRGetXMLResult', 'eLEXTYPE_PRIVATE14', 'IStream',
    'SGRSTTWord', 'SPEI_INTERFERENCE', 'SPPS_Noun',
    'SpeechLoadOption', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRCERequestUI', 'DISPID_SGRsCount', 'eLEXTYPE_PRIVATE8',
    'SPCT_SUB_COMMAND', 'DISPID_SRGRecoContext',
    'DISPID_SRCEStartStream', 'SPAR_High',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRSAudioStatus',
    'SDKLCurrentConfig', 'SPSMF_SAPI_PROPERTIES',
    'SAFTGSM610_8kHzMono', 'DISPID_SLPPartOfSpeech', 'SPSHT_OTHER',
    'SpeechLexiconType', 'ISpeechLexiconWord',
    'DISPID_SLGetPronunciations', 'DISPID_SPRs_NewEnum',
    'SP_VISEME_14', 'DISPID_SVGetVoices', 'SP_VISEME_2',
    'SPADAPTATIONRELEVANCE', 'DISPID_SASCurrentSeekPosition',
    'ISpVoice', 'SpeechRuleAttributes', 'DISPID_SOTDisplayUI',
    'SAFT8kHz8BitStereo', 'SVP_19', 'DISPID_SLWPronunciations',
    'SpMMAudioOut', 'DISPID_SPRuleParent',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPINTERFERENCE_TOOFAST',
    'ISpeechGrammarRules', 'DISPID_SPRsItem', 'DISPID_SGRsItem',
    'SP_VISEME_9', 'DISPID_SPEEngineConfidence', 'SDTReplacement',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SpeechWaveFormatEx', 'SPINTERFERENCE_NONE',
    'SPWT_PRONUNCIATION', 'SPPS_Function', 'SECFIgnoreWidth',
    'SPSHORTCUTPAIRLIST', 'SPTEXTSELECTIONINFO', 'UINT_PTR',
    'DISPID_SPISaveToMemory', 'SPDATAKEYLOCATION', 'SAFT8kHz8BitMono',
    'SPLOADOPTIONS', 'SREPrivate', 'DISPID_SRCEBookmark',
    'SPAS_PAUSE', 'SAFT12kHz8BitStereo', 'DISPID_SOTCEnumerateTokens',
    'SpeechStreamSeekPositionType', 'SPLEXICONTYPE', 'SPCATEGORYTYPE',
    'ISpeechRecognizer', 'SPAUDIOBUFFERINFO',
    'DISPID_SAFGetWaveFormatEx', 'SpeechMicTraining',
    'SpPhoneConverter', 'SPEI_UNDEFINED', 'SpeechGrammarTagWildcard',
    'DISPID_SWFEBitsPerSample', 'DISPID_SpeechPhraseReplacements',
    'SGDSActiveWithAutoPause', 'SAFT22kHz8BitMono', 'DISPID_SRCPause',
    'SVSFVoiceMask', 'DISPID_SOTSetId', 'SPPS_NotOverriden',
    'SVEStartInputStream', 'SAFT12kHz8BitMono', 'SPSHT_EMAIL',
    'DISPID_SRGDictationUnload', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SVP_17', 'DISPID_SWFEChannels', 'SPWAVEFORMATTYPE',
    'DISPID_SRGRules', 'SAFTADPCM_22kHzMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SpeechFileStream', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SDKGetBinaryValue', 'eLEXTYPE_PRIVATE3', 'SPWORD',
    'DISPID_SGRSAddSpecialTransition', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SRCEHypothesis', 'SGPronounciation', 'SRSInactive',
    'DISPID_SRGetPropertyString', 'STSF_FlagCreate', 'SPGRAMMARSTATE',
    'SPEI_TTS_PRIVATE', 'DISPID_SMSGetData', 'ISpResourceManager',
    'DISPID_SGRSTransitions', 'SpeechVisemeType',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SDKSetBinaryValue', 'SVF_None',
    'SRTStandard', 'DISPID_SBSSeek', 'ISpeechResourceLoader',
    'DISPID_SLGetWords', 'SAFTADPCM_8kHzStereo',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SGRSTText', 'SPXRO_SML',
    'SPFM_OPEN_READONLY', 'DISPID_SPEAudioStreamOffset',
    'ISpeechXMLRecoResult', 'SDKLDefaultLocation',
    'DISPID_SPEs_NewEnum', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPPParent',
    'DISPID_SpeechLexicon', 'SPFM_OPEN_READWRITE',
    'SPPS_SuppressWord', 'DISPID_SASFreeBufferSpace',
    'SPXRO_Alternates_SML', 'SVP_0', 'SpeechPropertyAdaptationOn',
    ...
    'DISPID_SWFEExtraData', 'DISPID_SVSLastBookmarkId', 'ISpAudio',
    'SpeechSpecialTransitionType', 'SAFTCCITT_ALaw_8kHzStereo',
    'SP_VISEME_3', 'DISPID_SpeechLexiconWords', 'SVSFlagsAsync',
    'SVP_16', 'ISpeechBaseStream', 'DISPID_SPAsItem',
    'eLEXTYPE_PRIVATE2', 'SpeechWordType', 'SpPhraseInfoBuilder',
    'SpeechVisemeFeature', 'DISPIDSPTSI_ActiveOffset',
    'DISPIDSPTSI_ActiveLength', 'eLEXTYPE_PRIVATE11',
    'SPPS_Interjection', 'SPRST_NUM_STATES', 'DISPID_SOTsCount',
    'DISPID_SPRDisplayAttributes', 'SpMMAudioIn',
    'DISPID_SVGetProfiles', 'SPWORDPRONUNCIATION',
    'IEnumSpObjectTokens', 'SPGS_DISABLED', 'SpeechRecognizerState',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechPhraseAlternates',
    'SSFMOpenReadWrite', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVSLastBookmark', 'DISPID_SAFType',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SOTCId',
    'DISPID_SRGetPropertyNumber', 'SLOStatic',
    'DISPID_SLGenerationId', 'SAFTDefault', 'DISPID_SLPType',
    'SPEI_START_SR_STREAM', 'SPWORDLIST', 'SPFM_NUM_MODES',
    'DISPID_SRCCmdMaxAlternates', 'SpeechBookmarkOptions',
    'SP_VISEME_20', 'SAFT24kHz8BitMono', 'SPCONTEXTSTATE',
    'SGRSTTWildcard', 'DISPID_SDKSetLongValue',
    'ISpeechRecoResultTimes', 'SVP_2',
    'SWPUnknownWordUnpronounceable', 'DISPID_SLGetGenerationChange',
    'ISpProperties', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPIGetText', 'STSF_LocalAppData', 'SpFileStream',
    'SPINTERFERENCE', 'DISPID_SGRId', 'DISPID_SRCEEndStream',
    'DISPID_SGRsAdd', 'SAFT24kHz8BitStereo', 'DISPID_SGRSTRule',
    'SREPropertyStringChange', 'SPPHRASEREPLACEMENT',
    'SAFTADPCM_44kHzMono', 'DISPID_SRSClsidEngine',
    'DISPID_SOTs_NewEnum', 'SP_VISEME_10',
    'DISPID_SpeechPhraseAlternates', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SpeechGrammarRules', 'eLEXTYPE_RESERVED10',
    'DISPID_SVIsUISupported', 'eLEXTYPE_PRIVATE12',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpStreamFormat', 'SVEVoiceChange',
    'IInternetSecurityManager', 'SpeechAllElements', 'SVP_15',
    'ISpeechObjectTokenCategory', 'DISPID_SFSOpen',
    'DISPID_SPPFirstElement', 'SPPS_RESERVED1',
    'SpPhoneticAlphabetConverter', 'SAFT16kHz16BitMono',
    'DISPID_SpeechGrammarRuleState', 'SDTPronunciation', 'SWTAdded',
    'DISPID_SRRPhraseInfo', 'SREInterference', 'SAFT12kHz16BitMono',
    'DISPID_SRCBookmark', 'SPGS_ENABLED',
    'DISPID_SPERetainedStreamOffset', 'SDTLexicalForm',
    'SPCS_ENABLED', 'DISPID_SPPs_NewEnum', 'SPRECOGNIZERSTATUS',
    'ISpShortcut', 'DISPID_SDKEnumKeys', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechVoiceEvent', 'SPEI_SOUND_START',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SGRsCommit',
    'DISPID_SPIEngineId', 'SPVPRIORITY', 'ISpeechPhraseProperty',
    'SPEI_ADAPTATION', 'SpeechCategoryPhoneConverters',
    'DISPID_SGRSAddRuleTransition', 'SpeechDataKeyLocation',
    'DISPID_SpeechRecoResult', 'DISPID_SPARecoResult',
    'DISPID_SPPBRestorePhraseFromMemory', 'SDTAudio',
    'DISPID_SPRuleChildren', 'DISPID_SRCEEnginePrivate',
    'SPINTERFERENCE_LATENCY_WARNING', 'SREBookmark', 'SRSActive',
    'DISPID_SLWType', 'DISPID_SVPriority',
    'SpeechPropertyResponseSpeed', 'SPEI_RESERVED6', 'SVP_7',
    'SSSPTRelativeToStart', 'SAFT24kHz16BitMono',
    'DISPID_SRAudioInputStream', 'SPWT_DISPLAY', 'SFTSREngine',
    'SAFT11kHz8BitMono', 'DISPID_SPIElements', 'SPRECOSTATE',
    'SAFTCCITT_uLaw_11kHzStereo', 'SDA_One_Trailing_Space',
    'SP_VISEME_0', 'ISpPhrase', 'SPCT_SLEEP', 'SVSFParseSapi',
    'SpeechTokenShellFolder', 'SP_VISEME_4', 'ISpeechPhraseAlternate',
    ...
    'DISPID_SVEStreamStart', 'ISpDataKey', 'SPPHRASE',
    'SAFTCCITT_ALaw_8kHzMono', 'SVSFParseAutodetect',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SLPLangId',
    'SpSharedRecognizer', 'SITooFast', 'DISPID_SRCEventInterests',
    'SPRECORESULTTIMES', 'DISPID_SPRFirstElement',
    'SAFT48kHz16BitStereo', 'SGDisplay', 'DISPID_SASNonBlockingIO',
    'DISPID_SGRSTWeight', 'DISPID_SPEAudioSizeTime', 'SpObjectToken',
    'DISPID_SRCRetainedAudio', 'SPAS_CLOSED',
    'DISPID_SPRules_NewEnum', 'SAFT44kHz16BitMono', 'SpMemoryStream',
    'DISPID_SRCVoice', 'DISPID_SpeechAudio', 'SVP_9',
    'DISPID_SpeechCustomStream', 'SpeechVoiceSkipTypeSentence',
    'SAFTADPCM_44kHzStereo', 'ISpeechLexiconWords',
    'SpeechRetainedAudioOptions', 'STCInprocHandler', 'SPPS_Modifier',
    'SPEVENT', 'DISPID_SRGSetTextSelection', 'SPEI_RESERVED1',
    'SDTAlternates', 'DISPID_SGRSTs_NewEnum', 'SPVOICESTATUS',
    'DISPID_SRCERecognizerStateChange', 'SRAONone', 'DISPID_SRCState',
    'ISpeechAudio', 'DISPID_SVEPhoneme', 'SGDSActive',
    'ISpPhoneticAlphabetSelection', 'SSFMOpenForRead',
    'SpCompressedLexicon', 'DISPID_SpeechPhraseElement',
    'SpeechWordPronounceable', 'DISPID_SRCERecognition',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SRSEIsSpeaking',
    'SAFT32kHz16BitMono', 'DISPID_SGRAddState', 'eLEXTYPE_APP',
    'SpeechGrammarTagDictation', 'ISpeechFileStream',
    'eLEXTYPE_RESERVED7', 'SPEI_RESERVED5', 'SRTReSent', 'SPAS_STOP',
    'SDTRule', 'DISPID_SPIAudioStreamPosition', 'DISPID_SRAudioInput',
    'SVP_3', 'DISPID_SpeechVoice', 'SpeechEngineConfidence',
    'SpeechPartOfSpeech', 'ISpRecognizer2', 'SPEI_PHRASE_START',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPRulesItem', 'SPRS_ACTIVE',
    'SPEI_SENTENCE_BOUNDARY', 'ISpNotifyTranslator',
    'ISpeechPhraseInfo', 'ISpRecoGrammar', 'SpResourceManager',
    'DISPID_SDKOpenKey', 'SASClosed', 'DISPID_SpeechMMSysAudio',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SP_VISEME_18', 'SAFT22kHz16BitMono',
    'eLEXTYPE_PRIVATE7', 'eLEXTYPE_RESERVED9',
    'DISPID_SVSInputSentencePosition', 'SPWORDPRONOUNCEABLE',
    'ISpXMLRecoResult', 'ISpeechVoice', 'DISPID_SBSFormat',
    'DISPID_SVSRunningState', 'SLTUser', 'DISPID_SGRSTPropertyName',
    'SPPROPERTYINFO', 'DISPID_SRCreateRecoContext',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SpeechPhraseInfo',
    'DISPID_SGRSTPropertyValue', 'SP_VISEME_5', 'STCAll',
    'DISPID_SVSInputWordLength', 'SpTextSelectionInformation',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SOTGetAttribute', 'DISPID_SVVoice', 'DISPID_SMSSetData',
    'SPPS_LMA', 'DISPID_SPRsCount', 'ISpeechRecoContext',
    'SPPS_Noncontent', 'DISPID_SLWLangId', 'SVEWordBoundary',
    'SPPS_RESERVED2', 'SpStream', 'DISPID_SDKGetStringValue',
    'DISPID_SRCVoicePurgeEvent', 'SPXMLRESULTOPTIONS',
    'SpeechRecognitionType', 'SRAInterpreter', 'SPPHRASEPROPERTY',
    'DISPID_SRCERecognitionForOtherContext', 'SP_VISEME_17',
    'DISPID_SGRInitialState', 'SPBO_TIME_UNITS',
    'SpObjectTokenCategory', 'SPRST_ACTIVE_ALWAYS',
    'STSF_CommonAppData', 'SITooLoud', 'ISpeechLexicon',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SVAudioOutput',
    'SPEI_MIN_TTS', 'SVEPhoneme', 'SpMMAudioEnum', 'DISPID_SAStatus',
    'SVP_20', 'DISPID_SGRSTType', 'SPSLMA', 'SREAdaptation',
    'SpLexicon', 'DISPIDSPTSI', 'DISPID_SVESentenceBoundary',
    'SpeechGrammarTagUnlimitedDictation', 'SREFalseRecognition',
    'SPINTERFERENCE_NOISE', 'DISPID_SPAsCount',
    'DISPID_SVGetAudioInputs', 'SpeechVoiceSpeakFlags',
    'DISPID_SRGetFormat', 'DISPID_SRCCreateResultFromMemory',
    'SREAllEvents', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRRRecoContext', 'DISPID_SVEWord', 'SDKLLocalMachine',
    'SpNullPhoneConverter', 'SRCS_Enabled',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVEAudioLevel',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SpeechObjectTokens',
    'DISPID_SFSClose', 'SRADefaultToActive',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechPhraseAlternate',
    'ISpLexicon', 'SPFILEMODE', 'DISPID_SRRDiscardResultInfo',
    'SPEI_START_INPUT_STREAM', 'SGRSTTDictation',
    'SPRECOCONTEXTSTATUS', 'SSTTDictation', 'ISpRecoCategory',
    'DISPID_SpeechVoiceStatus', 'SASStop',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRCCreateGrammar',
    'SDTDisplayText', 'DISPID_SVRate', 'SAFT16kHz16BitStereo',
    'SECFDefault', 'LONG_PTR', 'SPSInterjection', 'SpeechAudioVolume',
    'DISPID_SRGetRecognizers', 'SPSMF_UPS', 'SVSFNLPMask',
    'SGLexical', 'SP_VISEME_16', 'DISPID_SGRs_NewEnum',
    'SPBINARYGRAMMAR', 'SpeechTokenKeyFiles', 'eLEXTYPE_PRIVATE1',
    'SRSInactiveWithPurge', 'ISpeechRecoResult', '_SPAUDIOSTATE',
    'SPEI_VOICE_CHANGE', 'SAFT8kHz16BitStereo', 'SRCS_Disabled',
    'DISPID_SLRemovePronunciation', 'DISPID_SRCRecognizer',
    'DISPID_SRRTStreamTime', 'SPEI_TTS_BOOKMARK',
    'DISPID_SLPs_NewEnum', 'SPDKL_CurrentUser', 'SpeechVoiceEvents',
    'SpeechGrammarRuleStateTransitionType',
    'SpeechPropertyResourceUsage', 'SRESoundEnd', 'SREStateChange',
    'SpInprocRecognizer', 'SSTTWildcard', 'ISpeechGrammarRule',
    'SREPhraseStart', 'SRAORetainAudio', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpeechObjectToken', 'eLEXTYPE_PRIVATE10', 'ISpeechMemoryStream',
    ...
    'SAFT11kHz16BitStereo', 'ISpRecoResult',
    'DISPID_SpeechAudioBufferInfo', 'SRSActiveAlways', 'SBONone',
    'DISPID_SABIBufferSize', 'SpInProcRecoContext',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPAO_RETAIN_AUDIO',
    'DISPID_SRGId', 'SPGS_EXCLUSIVE', 'SPDKL_CurrentConfig',
    'DISPID_SPPChildren', 'STCInprocServer', 'SVPNormal',
    'SPWORDTYPE', 'SPCT_COMMAND', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SOTCGetDataKey', 'SVP_11', 'DISPID_SDKEnumValues',
    'SVPOver', 'SAFT11kHz16BitMono', 'SAFTGSM610_11kHzMono',
    'SpeechAudioFormatGUIDText', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVSpeak', 'DISPID_SRCSetAdaptationData', 'WAVEFORMATEX',
    'SVEViseme', 'DISPID_SVDisplayUI', 'SP_VISEME_19',
    'DISPID_SPEActualConfidence', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SOTRemove', 'ISpeechDataKey', 'SGRSTTTextBuffer',
    'SGRSTTRule', 'SRERecoOtherContext', 'SVSFParseSsml',
    'DISPID_SGRSTsCount', 'DISPID_SpeechPhraseProperties',
    'DISPID_SpeechAudioStatus', 'eLEXTYPE_PRIVATE4',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SRRSaveToMemory',
    'SREAudioLevel', 'SAFT48kHz16BitMono',
    'SpeechPropertyComplexResponseSpeed', 'SPEI_REQUEST_UI',
    'DISPID_SPRuleId', 'SpStreamFormatConverter',
    '__MIDL_IWinTypes_0009', 'SSSPTRelativeToCurrentPosition',
    'SGRSTTEpsilon', 'DISPID_SpeechGrammarRule', 'DISPID_SRRAudio',
    'SWTDeleted', 'SECLowConfidence', 'SSFMCreateForWrite'
]

_check_version('1.1.13', 1662938132.249110)
