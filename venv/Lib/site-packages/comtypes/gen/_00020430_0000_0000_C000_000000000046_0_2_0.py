...
__all__ = [
    'FONTSTRIKETHROUGH', 'OLE_XPOS_CONTAINER', 'OLE_TRISTATE',
    'OLE_ENABLEDEFAULTBOOL', 'IPicture', 'Font',
    'LoadPictureConstants', 'Picture', 'FONTNAME',
    'OLE_XSIZE_HIMETRIC', 'OLE_YPOS_CONTAINER', 'Gray', 'Default',
    'OLE_YSIZE_PIXELS', 'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_CONTAINER',
    'Monochrome', 'Checked', 'IFont', 'FONTITALIC', 'OLE_HANDLE',
    'StdFont', 'FONTUNDERSCORE', 'OLE_YPOS_HIMETRIC', 'IPictureDisp',
    'VgaColor', 'Unchecked', 'Color', 'StdPicture',
    'OLE_XSIZE_PIXELS', 'OLE_COLOR', 'OLE_XPOS_PIXELS', 'FONTSIZE',
    'FONTBOLD', 'OLE_YSIZE_HIMETRIC', 'IFontEventsDisp',
    'OLE_OPTEXCLUSIVE', 'FontEvents', 'OLE_XSIZE_CONTAINER',
    'OLE_CANCELBOOL', 'OLE_YPOS_PIXELS', 'IFontDisp'
]

_check_version('1.1.13', 1575709685.550032)
